...
if(!$sel)
   ...
   if(isset($_POST['submit']))
    {
    	$entry=mysql_query("SELECT * FROM personnel");
		if(!$entry)
				...
				<div class="span12">
					<div class="single-wrapper clearfix">
                     ...
                     <table class="table table-bordered">
                     	<tr>
                     		<td>
                     			<p style="font-size:15px">EMP_ID</p>
                     		</td>
                     		<td>
                     			<p style="font-size:15px">Nomenclature</p>
                     		</td>
                     		<td>
                     			<p style="font-size:15px">FullName</p>
                     		</td>

                     		<td>
                     			<p style="font-size:15px">FatherName</p>
                     		</td>
                     		<td>
                     			<p style="font-size:15px">FacilityName</p>
                     		</td>
                     		<td>
                     	...
                     	<tr>
                     		...
                     		<td>
                     			<p style="font-size:15px"><?php echo $id[$i];?></p>
                     		</td>
                     		<td>
                     			<p style="font-size:15px"><?php echo $nomenclature[$i];?></p>
                     		</td>
                     		<td>
                     			<p style="font-size:15px"><?php echo $fullname[$i];?></p>
                     		</td>

                     		<td>
                     			<p style="font-size:15px"><?php echo $fathername[$i];?></p>
                     		</td>

                     		<td>
                     			<p style="font-size:15px"><?php echo $facilityname[$i];?></p>
                     		</td>
                     		<td>
                     			<form action="view.php" method="POST">
                     				<input type="hidden" name="id" value="<?php echo $id[$i];?>">
                     			<button class="btn btn-inverse" type="submit">View More</button>
                     		</form>
                     		</td>
                     	</tr>
                     	<?php } ?>
